...
namespace PleaseStayWithUs.Data_Access_Layer
{
    public class LoginDAL
    {
        ...
        public string EmployeeLogin(string uname, string pwd)
        {
            ...
            try
            {
                loginObject = entityObject.Logins.Where(a => a.UserName == uname && a.Pwd == pwd).Single();
        ...
        public List<Course> CourseListDL( string search, string sort, string sortdir, int skip, int pageSize, out int totalRecord)
        {
