...
namespace PleaseStayWithUs.Business_Entity_Layer
{
    public class EmployeeBEL
    {
        ...
        public List<Cours> getCourseDetailsBL()
        {
            List<Cours> List = employeeDALObject.GetCourseDetailsDL();
            return List;
        }
        ...
        public List<Cours> availableCoursesBL()
        {
            try
            {
                List<Cours> CourseList = employeeDALObject.AvailableCourses();
                return CourseList;
            }
            catch (Exception e)
            {
