...
namespace PleaseStayWithUs.Data_Access_Layer
{
    public class EmployeeDAL
    {
        ...
        public int FeedbackScoreDL(int EID, int courseList, int MID, double score)
        {
            ...
            try
            {
                Cours TrainerObj = (from data in entityObject.Courses where data.CourseID == courseList select data).SingleOrDefault();
        ...
        public string RegisterCourseDL(int EID, int courseList)
        {
            ...
            Cours courseDetails = (from data in entityObject.Courses where data.CourseID == courseList select data).Single();
        ...
        public List<Cours> GetCourseDetailsDL()
        {
        ...
        public List<Cours> AvailableCourses()
        {
            DateTime todayDate = System.DateTime.Now;
            List<Cours> CourseList = new List<Cours>();
        ...
        public int FeedbackScoreNewDL(int RID, double score)
        {
            ...
            try
            {
                ...
                Cours courseObject = (from data in entityObject.Courses where data.CourseID == requestObject.CourseID select data).SingleOrDefault();
                Feedback feedbackObject = new Feedback();
